...
@bot.on(wiki_cmd(outgoing=True, pattern=r"setwelcome(?: |$)(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"checkwelcome$"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"rmwelcome$"))
