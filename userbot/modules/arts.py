...
async def _(event):
    await edit_or_reply(
        ...
        "`\n┳ﾐ(￣ ／`"
        "`\n┻┳T￣|`"
        "\n**Misi ka seleb mo typing**",
    )


@wiki_cmd(pattern="pantau(?: |$)(.*)")
async def _(event):
    await edit_or_reply(
        event,
        "`\n┻┳|―-∩`"
        ...
        "`\n┳ﾐ(￣ ／`"
        "`\n┻┳T￣|`"
        "\n**Niyamak ka, gk tau typing apa**",
    )


@wiki_cmd(pattern="frog(?: |$)(.*)")
async def _(event):
    await edit_or_reply(
        event,
        "⠄⠄⠄⠄⠄⣀⣀⣤⣶⣿⣿⣶⣶⣶⣤⣄⣠⣴⣶⣿⣶⣦⣄⠄\n"
