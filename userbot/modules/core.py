...
from userbot.utils import edit_or_reply, load_module, wiki_cmd, remove_plugin, reply_id


@wiki_cmd(pattern="install$")
async def _(event):
    if event.fwd_from:
        return
...
@wiki_cmd(pattern="uninstall (?P<shortname>\w+)")
