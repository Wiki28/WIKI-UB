...
@wiki_cmd(pattern="currency ([\d\.]+) ([a-zA-Z]+) ([a-zA-Z]+)")
...
@wiki_cmd(pattern=r"lang (tr|tts) (.*)")
...
@wiki_cmd(pattern="yt(audio|video( \d{0,4})?) (.*)")
