...
while 0 < 6:
    _GCAST_BLACKLIST = get(
        "https://raw.githubusercontent.com/Wiki28/Reforestation/Wiki-Userbot/blacklistgcast.json"
    )
    if _GCAST_BLACKLIST.status_code != 200:
        if 0 != 5:
            continue
        GCAST_BLACKLIST = [-1001473548283, -1001390552926, -1001658555612, -1001508910413]
        break
