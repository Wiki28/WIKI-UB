...
@bot.on(wiki_cmd(outgoing=True, pattern=r"(d)?fban(?: |$)(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"unfban(?: |$)(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"addf(?: |$)(.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"delf$"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"listf$"))
...
@bot.on(wiki_cmd(outgoing=True, pattern=r"clearf$"))
