...
from userbot.utils import bash, chrome, edit_or_reply, wiki_cmd, progress
...
@wiki_cmd(pattern="deez (.+?|) (FLAC|MP3\_320|MP3\_256|MP3\_128)")
async def _(event):
