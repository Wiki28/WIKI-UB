...
from userbot.utils import edit_delete, edit_or_reply, wiki_cmd, reply_id


@wiki_cmd(pattern=r"\#(\S+)")
...
@wiki_cmd(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
