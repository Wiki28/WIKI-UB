...
@bot.on(wiki_cmd(outgoing=True, pattern="filter (.*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern="filters$"))
...
@bot.on(wiki_cmd(outgoing=True, pattern="stop ([\s\S]*)"))
...
@bot.on(wiki_cmd(outgoing=True, pattern="rmallfilters$"))
